...
namespace Linergy
{
    class Quad : Energon
    {
        ...
        private QuadCollectedParticleSystem particles;

        public Quad(Game1 game)
        {
            this.sprite = this.sprite = game.QuadSprite;
            this.game = game;
            particles = new QuadCollectedParticleSystem(game, 1);
