...
namespace Linergy
{
    class PentaCollectedParticleSystem : ParticleSystem
    {
        public PentaCollectedParticleSystem(Game1 game, int howManyEffects)
        ...
        /// properties.
        /// </summary>
        /// Type is the type of Energon particle to use
        protected override void InitializeConstants()
        {

            textureFilename = "particles/pentaCollected";
