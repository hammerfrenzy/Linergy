...
namespace Linergy
{
    class QuadCollectedParticleSystem : ParticleSystem
    {
        public QuadCollectedParticleSystem(Game1 game, int howManyEffects)
        ...
        protected override void InitializeConstants()
        {
            ...
            textureFilename = "particles/quadCollected";
